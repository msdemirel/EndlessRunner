...
{
    [Header("References")]
    [SerializeField] private NotificationSamples.GameNotificationsManager manager = null;
    ...
    {
        var channel = new NotificationSamples.GameNotificationChannel(channelId, "Default Game Channel", "Generic notifications");
    ...
    public void ScheduleNotification(int id, string title, string body, DateTime deliveryTime)
    {
        ...
        NotificationSamples.IGameNotification notification = manager.CreateNotification();
